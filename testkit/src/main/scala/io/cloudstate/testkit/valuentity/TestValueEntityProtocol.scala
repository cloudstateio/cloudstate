...
import io.cloudstate.protocol.value_entity.{ValueEntityProtocolClient, ValueEntityStreamIn, ValueEntityStreamOut}
...
object TestValueEntityProtocol {
  ...
  final class Connection(client: ValueEntityProtocolClient, context: TestProtocolContext) {
