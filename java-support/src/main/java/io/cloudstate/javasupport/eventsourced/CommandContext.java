...
public interface CommandContext extends EventSourcedContext, ClientActionContext, EffectContext {
    ...
    /**
     * Emit the given event. The event will be persisted, and the handler of the event defined in the current behavior
     * will immediately be executed to pick it up.
     *
