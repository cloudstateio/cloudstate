...
/**
 * Marks a method as a update state handler.
 *
 ...
 *
 * <p>An entity must declare only one update state handler.
 *
 * <p>The update state handler method may additionally accept a {@link StateContext} parameter,
 * allowing it to access context for the state, if required.
 */
@CloudStateAnnotation
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface UpdateStateHandler {}
