This page documents how to implement Cloudstate event sourced entities in Java. For information on what Cloudstate event sourced entities are, please read the general xref:docs:concepts:eventsourced.adoc[Event sourcing] documentation first.

An event sourced entity can be created by annotating it with the link:api/io/cloudstate/javasupport/eventsourced/EventSourcedEntity.html[`@EventSourcedEntity`] annotation.
...
Command handlers can be declared by annotating a method with link:api/io/cloudstate/javasupport/eventsourced/CommandHandler.html[`@CommandHandler`]. They take a context class of type link:api/io/cloudstate/javasupport/eventsourced/CommandContext.html[`CommandContext`].
...
Event handlers are declared by annotating a method with link:api/io/cloudstate/javasupport/eventsourced/EventHandler.html[`@EventHandler`]. They take a context class of type link:api/io/cloudstate/javasupport/eventsourced/EventContext.html[`EventContext`].
