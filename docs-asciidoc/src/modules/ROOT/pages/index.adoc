...
. **A standards effort** — defining a specification, a protocol between the user functions and the backend, and a TCK.
...
| Developers
| * xref:java:index.adoc[Implemening stateful services in Java]
  * xref:javascript:index.adoc[Implementing stateful services in Javascript]
