...
Cloudstate requires a minimum Istio version of {minimum_istio_version}, prior versions don't offer the necessary annotations to bypass the service mesh, hence cluster formation is not possible.
