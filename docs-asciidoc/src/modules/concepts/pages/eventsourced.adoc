...
* xref:java:eventsourced.adoc[Implementing event sourced entities] in Java
* xref:javascript:eventsourced.adoc[Implementing event sourced entities] in Javascript
